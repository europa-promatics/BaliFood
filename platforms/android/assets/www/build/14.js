webpackJsonp([14],Array(430).concat([
/* 430 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_profile__ = __webpack_require__(786);
...
var EditProfilePage = (function () {
    function EditProfilePage(actionSheetCtrl, camera, viewCtrl, modalCtrl, loadingCtrl, alertCtrl, securityProvider, navCtrl, navParams, toastCtrl) {
        ...
        this.edit = {};
        this.edit.username = this.navParams.get('username');
        this.email = localStorage['email'];
        this.user_image = this.navParams.get('user_image');
        if (this.user_image) {
            this.pic = this.user_image;
        }
        else {
            this.pic = 'assets/imgs/profiler.png';
        }
    }
    ...
    EditProfilePage.prototype.dismiss = function () {
        var a = { user_image: localStorage['user_image'],
    ...
    EditProfilePage.prototype.fromgallery = function () {
        var _this = this;
        this.camera.getPicture({
            ...
            _this.edit.profileImage = base64Image;
            console.log(_this.edit.profileImage);
        }, function (err) {
            console.log('gallery not working');
        });
    };
    EditProfilePage.prototype.fromcamera = function () {
        var _this = this;
        this.camera.getPicture({
            destinationType: this.camera.DestinationType.DATA_URL,
        ...
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].fromPromise(loading.present())
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.userData) {
                    ...
                    console.log('edit' + localStorage['user_image']);
                    localStorage['username'] = b.username;
                    _this.img = b.profileImage;
    ...
    EditProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit-profile',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\edit-profile\edit-profile.html"*/'\n<ion-header>\n   <ion-navbar>\n      <ion-buttons start>\n         <button ion-button icon-only (click)="dismiss()">\n            <ion-icon name="close" class="close"></ion-icon>\n         </button>\n      </ion-buttons>\n      <ion-title>Edit Profile</ion-title>\n      <ion-buttons end >\n         <button ion-button icon-only (click)="OnSaveProfile()">\n            <ion-icon name="md-checkmark"></ion-icon>\n         </button>\n      </ion-buttons>\n   </ion-navbar>\n</ion-header>\n<ion-content class="content">\n   <div class="full-edit">\n      <div class="Edit-img"  (click)="presentActionSheet()">\n         <img  src={{pic}}>\n      </div>\n      <ion-item>\n         <ion-label stacked>Username</ion-label>\n         <ion-input type="text" [(ngModel)]="edit.username" ></ion-input>\n      </ion-item>\n      <ion-item>\n         <ion-label stacked>Email</ion-label>\n         <ion-input type="text" [(ngModel)]="email" disabled></ion-input>\n      </ion-item>\n   </div>\n</ion-content>\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\edit-profile\edit-profile.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */]])
    ], EditProfilePage);
