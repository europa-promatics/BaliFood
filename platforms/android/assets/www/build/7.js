webpackJsonp([7],Array(453).concat([
/* 453 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settings__ = __webpack_require__(830);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__ = __webpack_require__(736);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_contacts__ = __webpack_require__(761);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_security_security__ = __webpack_require__(69);
...
var SettingsPageModule = (function () {
    ...
    SettingsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_contacts__["a" /* Contacts */], __WEBPACK_IMPORTED_MODULE_9__providers_security_security__["a" /* SecurityProvider */]]
        })
    ], SettingsPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_fcm__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_contacts__ = __webpack_require__(761);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__ = __webpack_require__(467);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_security_security__ = __webpack_require__(69);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SettingsPage = (function () {
    function SettingsPage(loadingCtrl, securityProvider, contacts, fb, platform, translate, toastCtrl, actionSheetCtrl, alertCtrl, config, navCtrl, navParams, socialSharing, fcm, events) {
        var _this = this;
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            var loading = _this.loadingCtrl.create({
                                content: _this.popupMessages.Please_wait
                            });
                            __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].fromPromise(loading.present())
                                ...
                                return loading.dismiss().then(function () {
                                    ...
                                    if (a.success == true || a.success == 'true') {
                                        var message = _this.popupMessages.public_now;
                                        if (a.message == 'your account is private now') {
                                            message = _this.popupMessages.private_now;
                                        }
                                ...
                                return loading.dismiss().then(function () {
                                    ...
                                    if (a.success == true || a.success == 'true') {
                                        if (a.message == 'your account is public now') {
                                            message = _this.popupMessages.public_now;
                                        }
                                        else {
                                            message = _this.popupMessages.private_now;
                                        }
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].fromPromise(loading.present())
                            .flatMap(function (data) { return _this.securityProvider.toggleLanguageStatus(localStorage['user_id'], 0); })
                            .subscribe(function (data) {
                            return loading.dismiss().then(function () {
                                var a = data;
                                if (a.success == true || a.success == 'true') {
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].fromPromise(loading.present())
                            .flatMap(function (data) { return _this.securityProvider.toggleLanguageStatus(localStorage['user_id'], 1); })
                            .subscribe(function (data) {
                            return loading.dismiss().then(function () {
                                var a = data;
                                if (a.success == true || a.success == 'true') {
        ...
        this.contacts.find(["displayName", "name", "phoneNumbers"]).then(function (data) {
            ...
            if (data) {
                ...
                var toast = _this.toastCtrl.create({
                    message: _this.popupMessages.import_success,
                    duration: 2000,
                    position: "bottom"
                });
                toast.present(toast);
                for (var _i = 0, _a = _this.allContacts; _i < _a.length; _i++) {
                    ...
                    if (a_1._objectInstance.phoneNumbers != null) {
                        for (var _b = 0, _c = a_1._objectInstance.phoneNumbers; _b < _c.length; _b++) {
                            ...
                            var f = d.replace(/\D/g, "");
                            _this.contactListArray.push({ number: f, name: a_1.name.givenName });
                            //this.contactListArray.push({ number: f, name: a.displayName });
                            //alert(this.contactListArray[0]);
                            _this.contactNames.push({ number: f, name: a_1.name.givenName });
    ...
    SettingsPage.prototype.onNotification = function () {
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                {
                    text: agree,
                    handler: function (popData) {
                        var msg;
                        if (popData == 1) {
                            msg = _this.popupMessages.enabled_now;
                            localStorage['notistatus'] = 1;
                        }
                        if (popData == 0) {
                            msg = _this.popupMessages.disabled_now;
                        ...
                        __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].fromPromise(loading.present())
                            .flatMap(function (data) { return _this.securityProvider.toggleNotifications(localStorage['user_id'], popData); })
                            .subscribe(function (data) {
                            return loading.dismiss().then(function () {
                                var a = data;
                                if (a.success == true || a.success == 'true') {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-settings",template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\settings\settings.html"*/'<ion-header >\n    <ion-navbar hideBackButton>\n	<ion-buttons left>\n        <button ion-button (click)="goback()">\n           <ion-icon *ngIf="translate.currentLang==\'heb\'" class="backArrow" name="ios-arrow-back" style=" color: #ff8b00;margin: 0 6px;min-width: 44px; -webkit-box-shadow: none;box-shadow: none;font-size: 1.75em;"></ion-icon>\n           <ion-icon *ngIf="translate.currentLang==\'en\'" class="backArrow" name="ios-arrow-back" style=" color: #ff8b00;margin: 0 6px;min-width: 44px; -webkit-box-shadow: none;box-shadow: none;font-size: 1.75em;transform: rotate(180deg);"></ion-icon>\n        \n		</button>\n		</ion-buttons>\n        <ion-title> {{\'settings\' | translate}} </ion-title>  \n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <div class="setting-page">\n        <div class="block-div" (click)="onChangePassword()">\n            <h5>{{\'account\' | translate}}</h5>\n            {{\'changepassword\' | translate}}\n        </div>\n        <div class="block-div brd-b">\n            {{\'privateaccount\' | translate}} <span class="pull-right"><ion-toggle [(ngModel)]="pepperoni" (ngModelChange)="onTogglePrivacy(pepperoni)"></ion-toggle></span>\n\n            <p><small> {{\'settingtext\' | translate}}  </small></p>\n           \n        </div>\n\n        <div class="block-div brd-b">\n       \n            <h5>{{\'application\' | translate}}</h5>\n             <p (click)="onLanguageChange()">{{\'language\' | translate}}</p>\n            <p (click)="onNotification()">{{\'notificationssettings\' | translate}}</p>\n        </div>\n\n        <div class="block-div brd-b">\n            <h5>{{\'social\' | translate}}</h5>\n            <ul class="m-0 p-0 social-setting" type="none">\n                <li> <span class="icon"><ion-icon name="logo-facebook"></ion-icon> </span> {{\'importfriendsfromfb\' | translate}} </li>\n                <li (click)="onContactimport()"> <span class="icon"><i class="fa fa-address-book"></i> </span> {{\'importfromcontacts\' | translate}}</li>\n                <li (click)="onShareWith()"> <span class="icon"><img src="./assets/imgs/app-icon.png"> </span> {{\'recommendBalifood\' | translate}} </li>\n            </ul>\n        </div>\n\n        <div class="block-div brd-b">\n            <h5>{{\'support\' | translate}}</h5>\n            <ul class="m-0 p-0 social-setting no-icons" type="none">\n                <li (click)="onContact()"> {{\'contactus\' | translate}} </li>\n                \n            </ul>\n        </div>\n\n        <div class="block-div brd-b">\n            <h5>{{\'\'}}</h5>\n            <ul class="m-0 p-0 social-setting no-icons" type="none">\n                <li (click)="onAboutUs()"> {{\'aboutus\' | translate}} </li>\n                <li (click)="onTerm()"> {{\'terms\' | translate}}</li>\n                <li (click)="onFaq()"> {{\'faq\' | translate}} </li>\n            </ul>\n        </div>\n\n        <div class="block-div brd-b" (click)="onLogout()">\n            <h5 class="main-color">{{\'logout\' | translate}}</h5>\n        </div>\n       \n\n    </div>\n\n  \n</ion-content>\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\settings\settings.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_8__providers_security_security__["a" /* SecurityProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* Config */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["o" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__["a" /* SocialSharing */],
            __WEBPACK_IMPORTED_MODULE_1__ionic_native_fcm__["a" /* FCM */],
