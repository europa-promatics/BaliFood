webpackJsonp([16],Array(417).concat([
/* 417 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateMyEventsPageModule", function() { return CreateMyEventsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__create_my_events__ = __webpack_require__(773);
...
var CreateMyEventsPageModule = (function () {
    function CreateMyEventsPageModule() {
    }
    CreateMyEventsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__create_my_events__["a" /* CreateMyEventsPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__create_my_events__["a" /* CreateMyEventsPage */]),
                __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_6__ngx_translate_core__["b" /* TranslateModule */].forChild({})
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_5__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera__["a" /* Camera */]]
        })
    ], CreateMyEventsPageModule);
    return CreateMyEventsPageModule;
}());

//# sourceMappingURL=create-my-events.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CreateMyEventsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
...
var CreateMyEventsPage = (function () {
    function CreateMyEventsPage(alertCtrl, loadingCtrl, modalCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, translate, toastCtrl) {
        var _this = this;
    ...
    CreateMyEventsPage.prototype.presentConfirm = function () {
        var _this = this;
                ...
                return loading_1.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        ...
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.Create_eventsss,
                            duration: 3000,
                            position: 'top'
                        });
                        ...
                        alert.present(); */
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.missing_fields,
                            duration: 3000,
                            position: 'top'
                        });
                        toast1.onDidDismiss(function () {
    ...
    CreateMyEventsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-create-my-events',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\create-my-events\create-my-events.html"*/'<ion-header>\n   <ion-navbar>\n      <ion-title>{{\'createmyevent\' | translate}}</ion-title>\n      <ion-buttons start (click)="presentConfirm()">\n         <button ion-button >\n          {{\'cancel\' | translate}}\n         </button>\n      </ion-buttons>\n   </ion-navbar>\n</ion-header>\n<ion-content class="content">\n   <div class="event">\n      <div class="event-img" (click)="presentActionSheet()">\n         <img src={{pic}}>\n      </div>\n      <div class="event-item-input">\n         <ion-item>\n            <ion-input dir="rtl" type="text" placeholder="{{\'event\' | translate}}" [(ngModel)]="Event.event_name"></ion-input>\n            <ion-icon name="md-create" item-left></ion-icon>\n         </ion-item>\n      </div>\n      <div class="event-date-time">\n         <ion-item class="event-left">\n            <ion-datetime  style="direction:rtl" displayFormat="DD/MM/YYYY" pickerFormat="DD/MM/YYYY" dir="rtl" [(ngModel)]="Event.date" min={{min_date}} placeholder={{min_date}} max="2070-10-31"  [doneText]="translate.instant(\'done\')"    [cancelText]="translate.instant(\'cancel\')"></ion-datetime>\n            <ion-icon name="md-calendar" item-right></ion-icon>\n         </ion-item>\n         <ion-item class="event-right">\n            <ion-datetime displayFormat="HH:mm" pickerFormat="HH:mm" placeholder="{{\'time\' | translate}}" [(ngModel)]="Event.time"  [doneText]="translate.instant(\'done\')"    [cancelText]="translate.instant(\'cancel\')"></ion-datetime>\n            <ion-icon name="md-time" item-right></ion-icon>\n         </ion-item>\n      </div>\n      <div class="event-item-input">\n         <ion-item>\n            <ion-input type="text" placeholder="{{\'location\' | translate}}" [(ngModel)]="Event.address" ></ion-input>\n            <ion-icon name="ios-pin-outline" item-right></ion-icon>\n         </ion-item>\n      </div>\n   </div>\n   <div class="event-btn">\n      <button ion-button block (click)="onSave()" *ngIf="editEvent==false">{{\'create\' | translate}}</button>\n      <!--button ion-button block (click)="onAddMember()" *ngIf="editEvent==false;" disabled>Add Members</button>\n	  <button ion-button block (click)="onAddMember()" *ngIf="editEvent==true">Add Members</button>\n      <button ion-button block (click)="onMenuCreate()" *ngIf="editEvent==false" disabled>Create Menu</button>\n	   <button ion-button block (click)="onMenuCreate()" *ngIf="editEvent==true">Create Menu</button-->\n   </div>\n   <div class="pop-event" *ngIf="menuPopUp">\n      <div class="pop-event-wrap">\n         <div class="event-pop-text text-center">Create Menu</div>\n         <div class="pop-btn">\n			\n            <button ion-button block (click)="onCreateNewMenu()">Create New</button>\n            <button ion-button block (click)="onCreateExistingMenu()">From Existing Event</button>\n         </div>\n      </div>\n   </div>\n</ion-content>\n<!--ion-footer>\n   <button ion-button block (click)="onSave()">Save</button>\n</ion-footer-->\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\create-my-events\create-my-events.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */], __WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_5__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */]])
    ], CreateMyEventsPage);
