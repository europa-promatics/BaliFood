webpackJsonp([5],Array(444).concat([
/* 444 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main__ = __webpack_require__(821);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_camera__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_streaming_media__ = __webpack_require__(741);
    ...
    MainPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__main__["a" /* MainPage */]),
                __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__["b" /* TranslateModule */].forChild({}),
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_streaming_media__["a" /* StreamingMedia */]]
        })
    ], MainPageModule);
...
var MainPage = (function () {
    function MainPage(modalCtrl, streamingMedia, domSanitizer, loadingCtrl, alertCtrl, camera, socialSharing, securityProvider, navCtrl, translate, actionSheetCtrl, toastCtrl, events) {
    ...
    MainPage.prototype.getRecipeData = function (offset) {
        ...
        this.securityProvider.MainRecipe(offset)
            ...
            if (localStorage["private"] == "0") {
                ...
                if (data.Recipes) {
                    // alert(JSON.stringify(data.Recipes))
                    _this.recipedata.push(data.Recipes);
                }
            }
            else {
                if (data.recipesData) {
                    _this.recipedata.push(data.recipesData);
                }
                else {
                    _this.recipedata = [];
                }
    ...
    MainPage.prototype.share = function (recipeTitle, img) {
        ...
        this.socialSharing.share(message, file, url).then(function (data) {
            loading.dismiss();
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.message == "Data Saved") {
                    ...
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.recipe_saved,
                        duration: 3000,
                        position: 'top'
                    });
                    ...
                    /*   let alert = this.alertCtrl.create({
                      ...
                      alert.present(); */
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.Recipe_deleted,
                        duration: 3000,
                        position: 'top'
                    });
                    toast1.onDidDismiss(function () {
    ...
    MainPage.prototype.creatRecipeCameraold = function () {
        var _this = this;
    ...
    MainPage.prototype.fromcamera = function () {
        var _this = this;
        this.camera.getPicture({
            destinationType: this.camera.DestinationType.DATA_URL,
            sourceType: this.camera.PictureSourceType.CAMERA,
    ...
    MainPage.prototype.fromgallery = function () {
        var _this = this;
        this.camera.getPicture({
            destinationType: this.camera.DestinationType.DATA_URL,
