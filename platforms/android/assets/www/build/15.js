webpackJsonp([15],Array(429).concat([
/* 429 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_event__ = __webpack_require__(785);
    ...
    EditEventPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_event__["a" /* EditEventPage */]),
...
var EditEventPage = (function () {
    function EditEventPage(alertCtrl, loadingCtrl, modalCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, platform, translate, toastCtrl) {
        var _this = this;
                                ...
                                return loading_1.dismiss().then(function () {
                                    ...
                                    if (a.success == true) {
                                       ...
                                       alert.present(); */
                                        ...
                                        toast1.present();
                                        _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__tabs_tabs__["a" /* TabsPage */], { index: 2 });
                                    }
                                });
                            }, function (error) {
                                return loading_1.dismiss().then(function () { });
    ...
    EditEventPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit-event',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\edit-event\edit-event.html"*/'<ion-header>\n   <!--ion-navbar>\n      <ion-title>Edit Event</ion-title>\n      <ion-buttons start (click)="onEvent()">\n         <button ion-button *ngIf="enableEdit==false">\n          Cancel\n         </button>\n      </ion-buttons>\n      \n   </ion-navbar-->\n <ion-navbar hideBackButton >\n    <ion-buttons left>\n        <button ion-button (click)="onEvent()">\n           <ion-icon class="customIcon" name="ios-arrow-back"></ion-icon>\n        </button>\n		<!--button ion-button *ngIf="enableEdit==false">\n          {{\'cancel\' | translate}}\n        </button-->\n    </ion-buttons>\n	<ion-title>{{\'editevent\' | translate}}</ion-title>\n	</ion-navbar>\n</ion-header>\n<ion-content class="content">\n   <div class="event">\n      <div class="event-img" (click)="presentActionSheet()">\n         <img src={{pic}}>\n      </div>\n      <div class="event-item-input">\n         <ion-item>\n            <ion-input type="text" placeholder="Event" (ionChange)=\'enableEditing()\' [(ngModel)]="Event.event_name"></ion-input>\n            <ion-icon name="md-create" item-right></ion-icon>\n         </ion-item>\n      </div>\n      <div class="event-date-time">\n         <ion-item class="event-left">\n            <ion-datetime displayFormat="MM/DD/YYYY" pickerFormat="YYYY-MM-DD" [(ngModel)]="Event.date" min={{min_date}} placeholder={{min_date}} max="2070-10-31" (ionChange)=\'enableEditing()\' doneText="{{\'done\' | translate}}"    cancelText="{{\'cancel\' | translate}}" dir="rtl"></ion-datetime>\n            <ion-icon name="md-calendar" item-right></ion-icon>\n         </ion-item>\n         <ion-item class="event-right" (ionChange)=\'enableEditing()\'>\n            <ion-datetime displayFormat="HH:mm" pickerFormat="HH:mm" placeholder="Time" [(ngModel)]="Event.time" doneText="{{\'done\' | translate}}"    cancelText="{{\'cancel\' | translate}}" dir="rtl"></ion-datetime>\n            <ion-icon name="md-time" item-right></ion-icon>\n         </ion-item>\n      </div>\n      <div class="event-item-input">\n         <ion-item >\n            <ion-input type="text"  placeholder="Location" [(ngModel)]="Event.address" (ionChange)=\'enableEditing()\'></ion-input>\n            <ion-icon name="ios-pin-outline" item-right></ion-icon>\n         </ion-item>\n      </div>\n   </div>\n   <div class="event-btn">\n      <button ion-button block (click)="onAddMember()">{{\'editmembers\' | translate}}</button>\n       <button ion-button block (click)="onBringItem()" *ngIf="eventType==\'mutualEvent\'">{{\'editwtb\' | translate}}</button>\n      <button ion-button block (click)="onCreateNewMenu()">{{\'editmenu\' | translate}}</button>\n   </div>\n<!--    <div class="pop-event" *ngIf="menuPopUp">\n      <div class="pop-event-wrap">\n         <div class="event-pop-text text-center">Create Menu</div>\n         <div class="pop-btn">\n            <button ion-button block (click)="onCreateNewMenu()">Create New</button>\n            <button ion-button block (click)="onCreateExistingMenu()">From Existing Event</button>\n         </div>\n      </div>\n   </div> -->\n</ion-content>\n<ion-footer>\n   <button ion-button block [disabled]="enableEdit" (click)="onSave()">{{\'save\' | translate}}</button>\n</ion-footer>\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\edit-event\edit-event.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */], __WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* Platform */], __WEBPACK_IMPORTED_MODULE_6__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */]])
    ], EditEventPage);
