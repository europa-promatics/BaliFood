webpackJsonp([22],Array(425).concat([
/* 425 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditEventMenuItemFormPageModule", function() { return EditEventMenuItemFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_event_menu_item_form__ = __webpack_require__(781);
...
var EditEventMenuItemFormPageModule = (function () {
    function EditEventMenuItemFormPageModule() {
    }
    EditEventMenuItemFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__edit_event_menu_item_form__["a" /* EditEventMenuItemFormPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_event_menu_item_form__["a" /* EditEventMenuItemFormPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditEventMenuItemFormPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
 ...
 */
var EditEventMenuItemFormPage = (function () {
    function EditEventMenuItemFormPage(alertCtrl, securityProvider, loadingCtrl, viewCtrl, modalCtrl, navCtrl, navParams, translate, toastCtrl) {
        var _this = this;
    ...
    EditEventMenuItemFormPage.prototype.onSaveMenu = function () {
        ...
        if (this.menu_data) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].fromPromise(loading_1.present())
                ...
                return loading_1.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        ...
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.Menu_updated,
                            duration: 3000,
                            position: 'top'
                        });
                        ...
                        _this.navCtrl.push('EditEventMenuPage', { eventData: b, eventType: _this.eventType });
            ...
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].fromPromise(loading_2.present())
                ...
                return loading_2.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        /*  let alert = this.alertCtrl.create({
                         ...
                         alert.present(); */
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.Menu_Added,
                            duration: 3000,
                            position: 'top'
                        });
                        toast1.onDidDismiss(function () {
    ...
    EditEventMenuItemFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit-event-menu-item-form',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\edit-event-menu-item-form\edit-event-menu-item-form.html"*/'<ion-header>\n   <ion-navbar >\n      <ion-title>{{\'editmenu\' | translate}}</ion-title>\n      <ion-buttons start (click)="onClose()">\n         <button ion-button icon-only >\n            <ion-icon name="close" class="camera"></ion-icon>\n         </button>\n      </ion-buttons>\n   </ion-navbar>\n</ion-header>\n<ion-content class="content">\n   <ion-card>\n      <ion-card-content>\n         <ion-item >\n            <ion-input type="text" dir="rtl" placeholder="{{\'itemname\' | translate}}" [(ngModel)]="Menu.item_name" ></ion-input>\n         </ion-item>\n         <ion-item  *ngIf="eventType" (click)="Ownername()">\n         <ion-input dir="rtl" type="text" placeholder="{{\'ownername\' | translate}}" [(ngModel)]="Menu.owner_name" disabled></ion-input>\n         <ion-icon name="add" item-right ></ion-icon>\n         </ion-item>\n         <ion-item *ngIf="eventType">\n            <ion-label>{{\'status\' | translate}}</ion-label>\n            <ion-select dir="rtl" [(ngModel)]="Menu.status" okText="{{\'done\' | translate}}"    cancelText="{{\'cancel\' | translate}}">\n            <ion-option value="Pending">{{\'pending\' | translate}}</ion-option>\n            <ion-option value="Confirmed">{{\'confirmed\' | translate}}</ion-option>\n            <ion-option value="Rejected">{{\'rejected\' | translate}}</ion-option>\n            </ion-select>\n            <ion-icon name="ios-arrow-down" item-right></ion-icon>\n         </ion-item>\n         <ion-item>\n            <ion-input dir="rtl" type="text" placeholder="{{\'type\' | translate}}" [(ngModel)]="Menu.menuType"></ion-input>\n            <!--ion-icon name="ios-arrow-down" item-right></ion-icon-->\n         </ion-item>\n          <!--ion-item>\n            <ion-label>Grade</ion-label>\n            <ion-select [(ngModel)]="Menu.grade">\n            <ion-option value={{a}} *ngFor="let a of grades">{{a}}</ion-option>\n            </ion-select>\n            <ion-icon name="ios-arrow-down" item-right></ion-icon>\n         </ion-item-->\n\n           <!--ion-item >\n            <ion-input type="tel" placeholder="Score" [(ngModel)]="Menu.score" ></ion-input>\n         </ion-item-->\n         <ion-item (click)="onRecipeLink()">\n            <ion-input dir="rtl" type="text" placeholder="{{\'add_recipe_link\' | translate}}" [(ngModel)]="recipe_name" disabled></ion-input>\n            <ion-icon name="ios-link" item-right></ion-icon>\n         </ion-item>\n      </ion-card-content>\n   </ion-card>\n</ion-content>\n<ion-footer>\n   <button ion-button block (click)="onSaveMenu()">{{\'save\' | translate}}</button>\n</ion-footer>\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\edit-event-menu-item-form\edit-event-menu-item-form.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_3__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */]])
