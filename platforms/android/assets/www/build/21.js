webpackJsonp([21],Array(426).concat([
/* 426 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditEventMenuPageModule", function() { return EditEventMenuPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_event_menu__ = __webpack_require__(782);
...
var EditEventMenuPageModule = (function () {
    function EditEventMenuPageModule() {
    }
    EditEventMenuPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__edit_event_menu__["a" /* EditEventMenuPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_event_menu__["a" /* EditEventMenuPage */]),
    ...
    ], EditEventMenuPageModule);
    return EditEventMenuPageModule;
}());

//# sourceMappingURL=edit-event-menu.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditEventMenuPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
 ...
 */
var EditEventMenuPage = (function () {
    function EditEventMenuPage(securityProvider, loadingCtrl, alertCtrl, modalCtrl, navCtrl, navParams, translate) {
        var _this = this;
    ...
    EditEventMenuPage.prototype.check = function (object) {
        //console.log(object);
        if (object) {
            console.log(object);
            if (object[0]) {
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    var alert_1 = _this.alertCtrl.create({
                        subTitle: _this.popupMessages.Item_Removed,
    ...
    EditEventMenuPage.prototype.getTranslation = function (Menu) {
        if (Menu.status) {
            this.translate.get(Menu.status).subscribe(function (value) {
                Menu.status = value;
            });
        }
    };
    EditEventMenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit-event-menu',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\edit-event-menu\edit-event-menu.html"*/'<ion-header>\n   <ion-navbar hideBackButton >\n   <ion-buttons  left>\n        <button ion-button (click)="goBack()">\n           <ion-icon class="customIcon" name="ios-arrow-back"></ion-icon>\n        </button>\n    </ion-buttons>\n      <ion-title>{{\'editmenu\' | translate}}</ion-title>\n      <!--ion-buttons end (click)="onEvent()">\n         <button ion-button icon-only >\n            <ion-icon name="icon-event" class="camera"></ion-icon>\n         </button>\n      </ion-buttons-->\n   </ion-navbar>\n</ion-header>\n<ion-content class="content" padding>\n   <div class="btn-div">\n      <button ion-button block (click)="onAdd()">\n         {{\'addnewitem\' | translate}}\n         <ion-icon name="add"></ion-icon>\n      </button>\n   </div>\n   <div *ngIf="Menu_event">\n      <ion-card *ngFor="let Menu of Menu_event">\n	  \n         <ion-card-content *ngIf="Menu.deleted != true" >\n		 <ion-item>\n		  <ion-icon name="md-create" item-left (click)="onUpdateMenu(Menu)" *ngIf="editEvent"></ion-icon>\n		  <ion-icon name="trash" item-left (click)="presentConfirm(Menu._id, Menu)" *ngIf="editEvent"></ion-icon>\n		      <ion-icon style="color:orange;" *ngIf="Menu.owner_id!=me" ios="ios-refresh" md="md-refresh" item-left (click)="onDeleteOwner(Menu)" ></ion-icon>\n		 </ion-item>\n            <ion-item>\n               <ion-label>{{\'itemname\' | translate}}{{getTranslation(Menu)}}:</ion-label>\n               <ion-input dir="rtl" type="text" placeholder="Item name" [(ngModel)]="Menu.item_name" disabled></ion-input>\n            </ion-item>\n            <ion-item *ngIf="eventType!=\'myEvent\'">\n               <ion-label>{{\'ownername\' | translate}}:</ion-label>\n               <ion-input dir="rtl" type="text" placeholder="Owner" [ngModel]="Menu.owner_name" disabled></ion-input>\n			 \n            </ion-item>\n            <ion-item *ngIf="eventType!=\'myEvent\'">\n               <ion-label>{{\'status\' | translate}}:</ion-label>\n                <ion-input dir="rtl" type="text" placeholder="Status" [ngModel]="Menu.status" disabled></ion-input>\n            </ion-item>\n            <ion-item>\n               <ion-label>{{\'type\' | translate}}:</ion-label>\n               <ion-input dir="rtl" type="text" placeholder="Type" [(ngModel)]="Menu.menuType" disabled></ion-input>\n            </ion-item>\n            <!--ion-item>\n               <ion-label>Grade:</ion-label>\n               <ion-input type="text" placeholder="Type" [(ngModel)]="Menu.grade" disabled></ion-input>\n            </ion-item>\n             <ion-item>\n               <ion-label>Score:</ion-label>\n               <ion-input type="text" placeholder="Type" [(ngModel)]="Menu.score" disabled></ion-input>\n            </ion-item-->\n            <ion-item *ngIf="check(Menu.recipe_link)">\n               <!--ion-label>{{\'viewrecipelink\' | translate}}:</ion-label-->\n               <ion-label>  {{check(Menu.recipe_link)}}</ion-label>\n               <!--ion-input type="text" placeholder="{{\'addrecipelink\' | translate}}" [(ngModel)]="Menu.recipe_link" disabled></ion-input-->\n			 \n            </ion-item> \n         </ion-card-content>\n      </ion-card>\n   </div>\n</ion-content>\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\edit-event-menu\edit-event-menu.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["c" /* TranslateService */]])
    ], EditEventMenuPage);
