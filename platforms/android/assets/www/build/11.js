webpackJsonp([11],Array(443).concat([
/* 443 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_device__ = __webpack_require__(760);
...
var LoginPageModule = (function () {
    ...
    LoginPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_fcm__["a" /* FCM */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_device__["a" /* Device */]]
        })
    ], LoginPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_fcm__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_device__ = __webpack_require__(760);
...
var LoginPage = (function () {
    function LoginPage(platform, device, fcm, loadingCtrl, config, navParams, formBuilder, securityProvider, navCtrl, alertCtrl, translate, toastCtrl) {
        var _this = this;
        ...
        this.loginform = formBuilder.group({
            emailaddress: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].compose([
                    __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].maxLength(50),
                    __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].pattern(emailRegex),
            ...
            pass: [
                "",
                __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].compose([
                    __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].maxLength(12),
                    __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].minLength(3),
    ...
    LoginPage.prototype.onloginWeb = function () {
        var _this = this;
                ...
                return loading_1.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        ...
                        if (_this.navCtrl.parent != null) {
                            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_4__tabs_tabs__["a" /* TabsPage */], { parent: 0 });
                        }
                        else {
                        ...
                        if (a.message == 'email not registered with us') {
                            ...
                            var toast1 = _this.toastCtrl.create({
                                message: _this.popupMessages.emailNotRegistered,
                                duration: 3000,
                                position: 'top'
                            });
                        ...
                        if (a.message == 'incorrect Password') {
                           ...
                           alert.present(); */
                            var toast1 = _this.toastCtrl.create({
                                message: _this.popupMessages.incorrect_Password,
                                duration: 3000,
                                position: 'top'
                            });
                            toast1.onDidDismiss(function () {
                        ...
                        if (a.message != 'email not registered with us' && a.message != 'incorrect Password') {
                         ...
                         alert.present(); */
                            var toast1 = _this.toastCtrl.create({
                                message: _this.popupMessages.Something_went_wrong,
                                duration: 3000,
                                position: 'top'
                            });
                            toast1.onDidDismiss(function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-login",template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\login\login.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{\'loginpage.login\' | translate}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n<div class="logo-div">\n	<img src="assets/imgs/balifooddd.png" class="logo">\n</div>\n<div class="div-input">\n<form [formGroup]="loginform">\n	 <ion-item>\n    <ion-label stacked>{{\'loginpage.email\' | translate}}</ion-label>\n    <ion-input type="text" [(ngModel)]="email" formControlName="emailaddress" ></ion-input>\n     <ion-icon name="mail" item-right ></ion-icon>\n  </ion-item>\n  <p style="color:#ff8b00;padding-left: 15px;"  *ngIf="!loginform.controls.emailaddress.valid && (loginform.controls.emailaddress.dirty )"> *{{\'loginpage.invalidemail\' | translate}}.</p>\n\n  <ion-item>\n    <ion-label stacked>{{\'loginpage.password\' | translate}}</ion-label>\n    <ion-input type={{type}} [(ngModel)]="password" formControlName="pass"> </ion-input>\n         <ion-icon name="icon-password" item-right class="icon-color"></ion-icon>\n  </ion-item>\n  <p style="color:#ff8b00;padding-left: 15px;" *ngIf="!loginform.controls.pass.valid && (loginform.controls.pass.dirty )" > *{{\'loginpage.passlength\' | translate}}</p>\n<div class="div-input"><span class="pull-right" (click)="onHide()" *ngIf="type==\'text\'"><u>{{\'loginpage.hide\' | translate}}</u></span>\n<span class="pull-right" (click)="onShow()" *ngIf="type!=\'text\'"><u>{{\'loginpage.show\' | translate}}</u></span></div>\n</form>\n</div>\n<div class="btn-div1">\n	<button ion-button class="btn-login" (click)="onlogin()" [disabled]="!loginform.valid">{{\'loginpage.login\' | translate}}</button>\n\n	<button ion-button clear class="btn-forgot" (click)="onForgot()"><u>{{\'loginpage.forgetpassword\' | translate}}</u></button>\n	</div>\n<div class="btn-btm">\n	<button ion-button clear class="btn-already-acc" (click)="signup()">{{\'loginpage.dntHave\'| translate}} <u class="maincolor" >{{\'loginpage.signup\' | translate}}</u></button>\n</div>\n</ion-content>\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\login\login.html"*/
        }),
