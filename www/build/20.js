webpackJsonp([20],Array(427).concat([
/* 427 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditEventWhatToBringFormPageModule", function() { return EditEventWhatToBringFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_event_what_to_bring_form__ = __webpack_require__(783);
...
var EditEventWhatToBringFormPageModule = (function () {
    function EditEventWhatToBringFormPageModule() {
    }
    EditEventWhatToBringFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__edit_event_what_to_bring_form__["a" /* EditEventWhatToBringFormPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_event_what_to_bring_form__["a" /* EditEventWhatToBringFormPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditEventWhatToBringFormPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
 ...
 */
var EditEventWhatToBringFormPage = (function () {
    function EditEventWhatToBringFormPage(alertCtrl, securityProvider, loadingCtrl, viewCtrl, modalCtrl, navCtrl, navParams, translate, toastCtrl) {
        var _this = this;
        ...
        if (this.editbringItems) {
                ...
                return loading_1.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        /*  let alert = this.alertCtrl.create({
                           subTitle: this.popupMessages.Item_updated_successfully,
                           buttons: [this.popupMessages.ok]
                         });
                         alert.present(); */
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.Item_updated_successfully,
                            duration: 3000,
                            position: 'top'
                        });
            ...
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].fromPromise(loading_2.present())
                ...
                return loading_2.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        /* let alert = this.alertCtrl.create({
                          subTitle: this.popupMessages.Item_assigned_successfully,
                          buttons: [this.popupMessages.ok]
                        });
                        alert.present(); */
                        var toast1 = _this.toastCtrl.create({
                            message: _this.popupMessages.Item_assigned_successfully,
                            duration: 3000,
                            position: 'top'
                        });
                        toast1.onDidDismiss(function () {
