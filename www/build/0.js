webpackJsonp([0],Array(431).concat([
/* 431 */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventChatPageModule", function() { return EventChatPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event_chat__ = __webpack_require__(787);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ngx_translate_http_loader__ = __webpack_require__(340);
...
var EventChatPageModule = (function () {
    function EventChatPageModule() {
    }
    EventChatPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__event_chat__["a" /* EventChatPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__event_chat__["a" /* EventChatPage */]),
...
exports = module.exports = __webpack_require__(790);
exports.log = log;
...
var keys = __webpack_require__(797);
var hasBinary = __webpack_require__(754);
var sliceBuffer = __webpack_require__(798);
var after = __webpack_require__(799);
var utf8 = __webpack_require__(800);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(802);
}
...
var Blob = __webpack_require__(803);
...
var debug = __webpack_require__(737)('socket.io-parser');
var Emitter = __webpack_require__(738);
var binary = __webpack_require__(792);
var isArray = __webpack_require__(745);
var isBuf = __webpack_require__(750);
...
var hasCORS = __webpack_require__(795);
...
var parser = __webpack_require__(739);
var Emitter = __webpack_require__(738);
...
var eio = __webpack_require__(793);
var Socket = __webpack_require__(757);
var Emitter = __webpack_require__(738);
var parser = __webpack_require__(744);
var on = __webpack_require__(758);
var bind = __webpack_require__(759);
var debug = __webpack_require__(737)('socket.io-client:manager');
var indexOf = __webpack_require__(756);
var Backoff = __webpack_require__(808);
...
var XMLHttpRequest = __webpack_require__(746);
var XHR = __webpack_require__(796);
var JSONP = __webpack_require__(804);
var websocket = __webpack_require__(805);
...
var Transport = __webpack_require__(747);
var parseqs = __webpack_require__(742);
var parser = __webpack_require__(739);
var inherit = __webpack_require__(743);
var yeast = __webpack_require__(755);
var debug = __webpack_require__(737)('engine.io-client:polling');
...
var parser = __webpack_require__(744);
var Emitter = __webpack_require__(738);
var toArray = __webpack_require__(807);
var on = __webpack_require__(758);
var bind = __webpack_require__(759);
var debug = __webpack_require__(737)('socket.io-client:socket');
var parseqs = __webpack_require__(742);
var hasBin = __webpack_require__(754);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EventChatPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_socket_io_client__ = __webpack_require__(788);
 ...
 */
var EventChatPage = (function () {
    function EventChatPage(navCtrl, loadingCtrl, securityProvider, navParams, ngzone, toastCtrl, translate, config) {
        var _this = this;
        ...
        this.chatinp = '';
        this.socket = __WEBPACK_IMPORTED_MODULE_3_socket_io_client__["connect"]('http://18.218.43.56:5002');
        ...
        this.socket.on('message', function (msg) {
            ...
            _this.zone.run(function () {
                setTimeout(function () {
                    if ((_this.chathistory.length + _this.chats.length) > 10) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].fromPromise(loading.present())
    ...
    EventChatPage.prototype.closeModal = function () {
        this.navCtrl.pop();
    };
    ...
    EventChatPage.prototype.ionViewWillEnter = function () {
        this.tabBarElement.style.display = 'none';
    };
    EventChatPage.prototype.ionViewWillLeave = function () {
        this.tabBarElement.style.display = 'flex';
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* Content */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* Content */])
    ], EventChatPage.prototype, "content", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["s" /* Tabs */], { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */] }),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], EventChatPage.prototype, "tabs", void 0);
    EventChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-event-chat',template:/*ion-inline-start:"E:\Balifood\Balifood\src\pages\event-chat\event-chat.html"*/'<!--\n  Generated template for the EventChatPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{eventData.event_name}}</ion-title>\n  <ion-buttons start>\n                <button ion-button icon-only (click)="closeModal()">\n                     <ion-icon style="color:orange" ios="ios-close" md="md-close"></ion-icon>\n                </button>\n  </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding class="chat">\n	<ion-item>\n		<div class="event-chat-sec">\n			<div class="chat-window">\n				<div *ngIf="!chats" class="date-time"> Start Your Conversation!  </div>\n				<ul class="chat-msg"  >\n					<li *ngFor="let message of chathistory" class="{{getLiClassName(message)}}">\n						<div class="chat-text"> {{message.message}} </div>\n						<div class="chat-name" *ngIf="message.sender_id!=me">{{message.sender_name}} </div>\n					</li>\n					<li *ngFor="let message of chats" class="{{getLiClassName(message)}}">\n						<div class="chat-text"> {{message.message}} </div>\n						<div class="chat-name" *ngIf="message.sender_id!=me">{{message.sender_name}} </div>\n					</li>\n				</ul>\n			</div>\n			\n		\n		</div>\n	</ion-item>\n	\n</ion-content>\n<ion-footer style="background-color: white;border: 5px solid whitesmoke; 		border-top: 1px solid #ff8b00;width: 100%">\n  <div class="bidfoot">\n    <ion-input type="text" class="bidinput" [(ngModel)]="chatinp" (input)="chatinp[0]==\' \'?chatinp=\'\':chatinp=chatinp" placeholder="{{\'wam\'| translate}}"></ion-input>\n    <button ion-button class="bidbutton" (click)="send(chatinp)">{{\'send\'| translate}}</button>\n  </div>\n</ion-footer>\n\n\n'/*ion-inline-end:"E:\Balifood\Balifood\src\pages\event-chat\event-chat.html"*/,
            providers: []
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_5__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgZone */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["t" /* ToastController */], __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* Config */]])
    ], EventChatPage);
...
var url = __webpack_require__(789);
var parser = __webpack_require__(744);
var Manager = __webpack_require__(751);
var debug = __webpack_require__(737)('socket.io-client');
...
exports.Manager = __webpack_require__(751);
exports.Socket = __webpack_require__(757);
...
var parseuri = __webpack_require__(749);
var debug = __webpack_require__(737)('socket.io-client:url');
...
exports.humanize = __webpack_require__(791);
 ...
 *
 */
module.exports.parser = __webpack_require__(739);
...
var transports = __webpack_require__(752);
var Emitter = __webpack_require__(738);
var debug = __webpack_require__(737)('engine.io-client:socket');
var index = __webpack_require__(756);
var parser = __webpack_require__(739);
var parseuri = __webpack_require__(749);
var parseqs = __webpack_require__(742);
...
Socket.Transport = __webpack_require__(747);
Socket.transports = __webpack_require__(752);
Socket.parser = __webpack_require__(739);
...
var XMLHttpRequest = __webpack_require__(746);
var Polling = __webpack_require__(753);
var Emitter = __webpack_require__(738);
var inherit = __webpack_require__(743);
var debug = __webpack_require__(737)('engine.io-client:polling-xhr');
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(801)(module), __webpack_require__(70)))
...
var inherit = __webpack_require__(743);
var yeast = __webpack_require__(755);
var debug = __webpack_require__(737)('engine.io-client:websocket');
var BrowserWebSocket = global.WebSocket || global.MozWebSocket;
var NodeWebSocket;
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(806);
  } catch (e) { }
}
