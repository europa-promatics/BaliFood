webpackJsonp([3],Array(439).concat([
/* 439 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImportRecipeImagePageModule", function() { return ImportRecipeImagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__import_recipe_image__ = __webpack_require__(816);
...
var ImportRecipeImagePageModule = (function () {
    function ImportRecipeImagePageModule() {
    }
    ImportRecipeImagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__import_recipe_image__["a" /* ImportRecipeImagePage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__import_recipe_image__["a" /* ImportRecipeImagePage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ImportRecipeImagePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
...
var ImportRecipeImagePage = (function () {
    function ImportRecipeImagePage(transfer, file, loadingCtrl, imagePicker, alertCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, popoverCtrl, viewCtrl, translate, toastCtrl, events) {
        var _this = this;
    ...
    ImportRecipeImagePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ImportRecipeImagePage');
    };
    ImportRecipeImagePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ImportRecipeImagePage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    ImportRecipeImagePage.prototype.onSave = function () {
        var _this = this;
        var mandatoryfields = [];
            ...
            __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].fromPromise(loading_1.present())
                ...
                return loading_1.dismiss().then(function () {
                    ...
                    if (a.success == true) {
                        ...
                        var mesaage = _this.popupMessages.Post_successfully;
                        if (_this.video) {
    ...
    ImportRecipeImagePage.prototype.uploadMultiimage = function () {
    ...
    ImportRecipeImagePage.prototype.onIngredients = function (value) {
        if (!value) {
        }
        else {
    ...
    ImportRecipeImagePage.prototype.remove_btn = function (index) {
        var index1 = this.Recipes.ingredients.indexOf(index);
        this.Recipes.ingredients.splice(index1, 1);
    };
    ImportRecipeImagePage.prototype.onInstruction = function (value) {
        if (!value) {
        }
        else {
    ...
    ImportRecipeImagePage.prototype.remove_instruction = function (index) {
        var index1 = this.Recipes.instructions.indexOf(index);
        this.Recipes.instructions.splice(index1, 1);
    };
    ImportRecipeImagePage.prototype.inst_edit_btn = function (index, value) {
    ...
    ImportRecipeImagePage.prototype.ing_edit_btn = function (index, value) {
    ...
    ImportRecipeImagePage.prototype.upload = function (message) {
        var _this = this;
    ...
    ImportRecipeImagePage.prototype.onImports = function () {
        var _this = this;
    ...
    ImportRecipeImagePage.prototype.fromgallery = function () {
        var _this = this;
    ...
    ImportRecipeImagePage.prototype.fromcamera = function () {
        var _this = this;
        this.camera.getPicture({
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    ImportRecipeImagePage.prototype.onMultiImg = function () {
        var _this = this;
        var actionSheet = this.actionSheetCtrl.create({
            title: this.popupMessages.Select_Image_Source,
            buttons: [{
    ...
    ImportRecipeImagePage.prototype.takePhoto = function () {
        var _this = this;
        var options = {
            destinationType: this.camera.DestinationType.DATA_URL,
            sourceType: this.camera.PictureSourceType.CAMERA,
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.imagetext = 'Add More Image';
            _this.multiImage.push(_this.base64Image);
        }, function (err) {
        });
    };
    ImportRecipeImagePage.prototype.Multiimage = function () {
        var _this = this;
        var options = {
            width: 800,
            height: 800,
    ...
    ImportRecipeImagePage.prototype.onVideo = function () {
        var _this = this;
        var options = {
            quality: 50,
    ...
    ImportRecipeImagePage.prototype.onCancel = function () {
        var _this = this;
