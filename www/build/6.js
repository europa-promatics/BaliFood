webpackJsonp([6],Array(445).concat([
/* 445 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__my_events__ = __webpack_require__(822);
...
var MyEventsPageModule = (function () {
    function MyEventsPageModule() {
    }
    MyEventsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__my_events__["a" /* MyEventsPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_5__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__my_events__["a" /* MyEventsPage */]),
                __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__["b" /* TranslateModule */].forChild({ loader: {
                        provide: __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__["a" /* TranslateLoader */],
                        useFactory: HttpLoaderFactory,
                        deps: [__WEBPACK_IMPORTED_MODULE_5__angular_common_http__["a" /* HttpClient */]]
                    } }),
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_3__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_file__["a" /* File */]]
        })
    ], MyEventsPageModule);
    return MyEventsPageModule;
}());

//# sourceMappingURL=my-events.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file_transfer__ = __webpack_require__(734);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tabs_tabs__ = __webpack_require__(152);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyEventsPage = (function () {
    function MyEventsPage(transfer, file, actionSheetCtrl, camera, alertCtrl, loadingCtrl, translate, securityProvider, navCtrl, navParams, platform, toastCtrl, app, modalCtrl) {
        var _this = this;
    ...
    MyEventsPage.prototype.eventList = function () {
        if (this.navParams.get('lastPage') == 'notifications') {
            ...
            //alert('here');
            this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__tabs_tabs__["a" /* TabsPage */], { index: 2 });
        }
    };
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    var alert_1 = _this.alertCtrl.create({
                        subTitle: _this.popupMessages.grades_added,
                        buttons: [_this.popupMessages.ok]
                    });
                    //  alert.present();
                    menu.grades = value;
                    _this.refreshEvent();
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    ...
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.Member_deleted,
                        duration: 3000,
                        position: 'top'
                    });
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    /* 	 let alert = this.alertCtrl.create({
                            ...
                            alert.present(); */
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.event_del,
                        duration: 3000,
                        position: 'top'
                    });
                    toast1.onDidDismiss(function () {
    ...
    MyEventsPage.prototype.onPostImage = function (image) {
        ...
        fileTransfer.upload(image, heroesUrl + 'addEventImages/' + this.eventData._id, options)
            ...
            /* let alert = this.alertCtrl.create({
               ...
               alert.present(); */
            var toast1 = _this.toastCtrl.create({
                message: _this.popupMessages.image_post,
                duration: 3000,
                position: 'top'
            });
            toast1.onDidDismiss(function () {
    ...
    MyEventsPage.prototype.filterMygrade = function (grades) {
        var grade = grades.filter(function (item) { return item.userId == localStorage['user_id']; });
        // alert(grade[0].grade);
        if (grade[0]) {
