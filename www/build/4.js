webpackJsonp([4],Array(456).concat([
/* 456 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewRecipesPageModule", function() { return ViewRecipesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_recipes__ = __webpack_require__(833);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_social_sharing__ = __webpack_require__(736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_streaming_media__ = __webpack_require__(741);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_photo_viewer__ = __webpack_require__(762);
...
var ViewRecipesPageModule = (function () {
    function ViewRecipesPageModule() {
    }
    ViewRecipesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__view_recipes__["a" /* ViewRecipesPage */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__view_recipes__["a" /* ViewRecipesPage */]),
                __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__["b" /* TranslateModule */].forChild({})
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_security_security__["a" /* SecurityProvider */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_photo_viewer__["a" /* PhotoViewer */]]
        })
    ], ViewRecipesPageModule);
    return ViewRecipesPageModule;
}());

//# sourceMappingURL=view-recipes.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewRecipesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tabs_tabs__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_photo_viewer__ = __webpack_require__(762);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_streaming_media__ = __webpack_require__(741);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ViewRecipesPage = (function () {
    function ViewRecipesPage(streamingMedia, domSanitizer, loadingCtrl, socialSharing, alertCtrl, securityProvider, navCtrl, navParams, translate, events, toastCtrl, photoViewer) {
        var _this = this;
        ...
        this.securityProvider.AddtoMyRecipe(a)
            ...
            if (a.message == "Data Saved") {
                ...
                var alert_2 = _this.alertCtrl.create({
                    title: _this.popupMessages.Recipe_deleted_save,
        ...
        this.securityProvider.deleteRecipe(a)
            ...
            if (a.success == 'true' || a.success == true) {
                var alert_3 = _this.alertCtrl.create({
                    subTitle: _this.popupMessages.Recipe_deleted_successfully,
                    buttons: [_this.popupMessages.ok]
                });
                alert_3.present();
                _this.navCtrl.pop();
                _this.events.publish('recipe:deleted', _this.recipe_data);
                // this.navCtrl.pop();
            }
            else {
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    ...
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.Post_successfully,
                        duration: 3000,
                        position: 'top'
                    });
                    ...
                    toast1.present();
                    _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__tabs_tabs__["a" /* TabsPage */], { index: 0 });
                }
                else {
    ...
    ViewRecipesPage.prototype.onattchedRecipe = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].fromPromise(loading.present())
            ...
            return loading.dismiss().then(function () {
                var alert = _this.alertCtrl.create({
                    message: _this.popupMessages.Doyouwant,
                    buttons: [
                        {
                            text: _this.popupMessages.cancel,
                            role: 'cancel',
                            handler: function () {
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    /*   let alert = this.alertCtrl.create({
                      ...
                      alert.present(); */
                    var toast1 = _this.toastCtrl.create({
                        message: _this.popupMessages.Post_successfully1,
                        duration: 3000,
                        position: 'top'
                    });
                    toast1.onDidDismiss(function () {
                    ...
                    toast1.present();
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__tabs_tabs__["a" /* TabsPage */], { index: 0 });
                }
                else {
    ...
    ViewRecipesPage.prototype.getRecipeCategories = function () {
