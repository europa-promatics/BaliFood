...
signupopen (data): Observable<any> {
  ...
  checkUserPhone (a): Observable<any> {
     const url = `${heroesUrl}checkPhone/`+a;
  ...
  FrontRecipe (offset): Observable<any> {
	   var url;
...
login_fb_service(data){
 ...
 MyRecipe(id): Observable<any> {
  ...
  toggleNotifications(id, status): Observable<any> {
     const url = `${heroesUrl}notificationStatus/`+id+'/'+status;
    return this.http.get<any>(url,httpOptions)
    .pipe(
        tap(heroes => this.log(`saloonUpdate`)),
        catchError(this.handleError('saloonUpdate', []))
    ...
    toggleLanguageStatus(id, status): Observable<any> {
     const url = `${heroesUrl}languageStatus/`+id+'/'+status;
    return this.http.get<any>(url,httpOptions)
    .pipe(
        tap(heroes => this.log(`saloonUpdate`)),
        catchError(this.handleError('saloonUpdate', []))
...
Addcomment(data):Observable<any> {
  ...
  UserActiveStatus(id):Observable<any> {
    ...
    AllUserFriend(id,account):Observable<any> {
     const url = `${heroesUrl}getAllUsrers/`+id+`/`+account;
    return this.http.get<any>(url,httpOptions)
    .pipe(
        tap(heroes => this.log(`saloonUpdate`)),
        catchError(this.handleError('saloonUpdate', []))
 ...
 onUpdateCount(id): Observable<any> {
     const url = `${heroesUrl}updateSeenStatus/`+id;
    return this.http.get<any>(url,httpOptions)
    .pipe(
        tap(heroes => this.log(`saloonUpdate`)),
        catchError(this.handleError('saloonUpdate', []))
