...
var SignupPage = /** @class */ (function () {
    function SignupPage(formBuilder, alertCtrl, securityProvider, navCtrl) {
    ...
    SignupPage = __decorate([
        ...
        __metadata("design:paramtypes", [FormBuilder, AlertController, SecurityProvider, NavController])
    ], SignupPage);
    return SignupPage;
}());
export { SignupPage };
