...
export class AccountFriendsPage {
  ...
  contactData2
  popupMessages
  constructor(public loadingCtrl: LoadingController, public securityProvider: SecurityProvider, public navCtrl: NavController, public navParams: NavParams, private translate: TranslateService) {
	...
	var b= localStorage['private'];
     this.securityProvider.AllUserFriend(a, b)
      .subscribe(data => {
		...
		this.allUser=	a.allUsers.filter(d=>d.friendStatus=="true");
 ...
 capitalizeFirstLetter(string) {
  ...
  onAddToFriend(number, recipient_id, friend) {
	  friend.sent=true;
    var a = {
