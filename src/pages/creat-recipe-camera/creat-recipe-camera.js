...
var CreatRecipeCameraPage = /** @class */ (function () {
    function CreatRecipeCameraPage(modalCtrl, loadingCtrl, formBuilder, imagePicker, alertCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, popoverCtrl, viewCtrl) {
    ...
    CreatRecipeCameraPage.prototype.onCancel = function () {
        ...
        var alert = this.alertCtrl.create({
            title: 'Are you sure you want to cancel the recipe?',
            buttons: [{
                    text: 'Cancel',
                    role: 'cancel',
                    handler: function () {
    ...
    CreatRecipeCameraPage = __decorate([
        ...
        __metadata("design:paramtypes", [ModalController, LoadingController, FormBuilder, ImagePicker, AlertController, SecurityProvider, ActionSheetController, Camera, NavController, NavParams, PopoverController, ViewController])
