...
const heroesUrl = 'http://ionicteam.com:5001/api/';
@IonicPage()
@Component({
  selector: 'page-import-recipe-url',
  templateUrl: 'import-recipe-url.html',
})
export class ImportRecipeUrlPage {
  public photos:any
 ...
 ngOnInit() {
  ...
  onSave(){
          ...
          .subscribe(data =>
            loading.dismiss().then(() => {
              ...
              if (a.success == true) {
                ...
                var mesaage = this.popupMessages.Recipe_Imported_Successfully;
   ...
   var a={
    ...
    Observable.fromPromise(loading.present())
      .flatMap(data => this.securityProvider.AddtoMyRecipe(a))
      .subscribe(data =>
        loading.dismiss().then(() => {
          var a = data;
        }),
