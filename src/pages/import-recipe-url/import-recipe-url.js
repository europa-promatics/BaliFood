...
var ImportRecipeUrlPage = /** @class */ (function () {
    function ImportRecipeUrlPage(transfer, file, loadingCtrl, imagePicker, alertCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, popoverCtrl, viewCtrl) {
        ...
        if (this.ImportUrlData) {
            this.Recipes.recipeTitle = this.ImportUrlData.title;
            this.Recipes.description = this.ImportUrlData.description;
            this.Recipes.mainImage = this.ImportUrlData.image;
            this.pic = this.ImportUrlData.image;
        ...
        Observable.fromPromise(loading.present())
            ...
            return loading.dismiss().then(function () {
                ...
                if (a.success == true) {
                    ...
                    var mesaage = "Recipe Imported Successfully!";
    ...
    ImportRecipeUrlPage = __decorate([
        IonicPage(),
        Component({
            selector: 'page-import-recipe-url',
            templateUrl: 'import-recipe-url.html',
        }),
        __metadata("design:paramtypes", [FileTransfer, File, LoadingController, ImagePicker, AlertController, SecurityProvider, ActionSheetController, Camera, NavController, NavParams, PopoverController, ViewController])
    ], ImportRecipeUrlPage);
    return ImportRecipeUrlPage;
}());
export { ImportRecipeUrlPage };
