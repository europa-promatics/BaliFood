...
username
user_image
	constructor(public actionSheetCtrl: ActionSheetController, private camera: Camera, public viewCtrl: ViewController, public modalCtrl: ModalController, public loadingCtrl: LoadingController, public alertCtrl: AlertController, public securityProvider: SecurityProvider, public navCtrl: NavController, public navParams: NavParams, public toastCtrl: ToastController) {
		this.edit = {}
...
,username:localStorage['username']}
	...
	fromgallery() {
		this.camera.getPicture({
			...
			this.edit.profileImage = base64Image;
			console.log(this.edit.profileImage);
		}, (err) => {
	...
	OnSaveProfile() {
		...
		Observable.fromPromise(loading.present())
			.flatMap(data => this.securityProvider.ChangeProfile(this.edit, user_id))
			.subscribe(data =>
