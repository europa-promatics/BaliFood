...
var AccountPage = /** @class */ (function () {
    function AccountPage(loadingCtrl, modalCtrl, securityProvider, navCtrl, navParams) {
    ...
    AccountPage.prototype.allRecipe = function () {
        var _this = this;
        this.securityProvider.MainRecipe()
            .subscribe(function (data) {
    ...
    AccountPage = __decorate([
        ...
        __metadata("design:paramtypes", [LoadingController, ModalController, SecurityProvider, NavController, NavParams])
    ], AccountPage);
    return AccountPage;
}());
export { AccountPage };
