...
export class CreateNewMenuPage {
  ...
  menuData
  menuPopUp
  constructor(public modalCtrl: ModalController, public navCtrl: NavController, public navParams: NavParams,public loadingCtrl: LoadingController, private securityProvider:SecurityProvider) {
    this.Menu = {}
